...
public class SmsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        smobile = view.findViewById(R.id.firstname);
        stitle = view.findViewById(R.id.lastname);
        sdes = view.findViewById(R.id.semail);
        squantity = view.findViewById(R.id.spassword);
        sprice = view.findViewById(R.id.scpassword);
